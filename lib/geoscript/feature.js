...
var FeatureType = function(config) {
    ...
    // atts property
    this.atts = this.ft.attributeDescriptors.toArray().map(function(ad) {
        return [ad.localName, getTypeName(ad.type.binding)];
    });
    
    // attNames property
    this.attNames = this.ft.attributeDescriptors.toArray().map(function(ad) {
        return ad.localName;
    });

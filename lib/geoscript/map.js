...
var Map = UTIL.extend(Object, {
    ...
    _setContext: function() {
        ...
        this.layers.forEach(function(layer) {
            var _layer = new DefaultMapLayer(layer._source, layer.style._style);
            _context.addLayer(_layer);
        });
        if (this.projection) {
            _context.setCoordinateReferenceSystem(this.projection._projection);
        }
        this._renderer.setContext(_context);
    ...
    get bounds() {
        if (!this.cache.bounds) {
            ...
            this.cache.bounds = Bounds.from_(_bounds);
        }

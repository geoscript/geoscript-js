...
// add assorted types
addTypeMapping("Feature", geotools.feature.simple.SimpleFeatureImpl);
...
var Field = UTIL.extend(Object, {
    ...
    valueFrom_: function(_value) {
        ...
        if (value !== null) {
            ...
            } else if (_value instanceof geotools.feature.simple.SimpleFeatureImpl) {
                var Feature = require("./feature").Feature;
                value = Feature.from_(_value);
            } else {
                var type = this.type;

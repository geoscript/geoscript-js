...
// add type name mapping for java.util.Date
types["Date"] = java.util.Date;
types[java.util.Date] = java.util.Date;
// add type name mapping for java.math.BigDecimal
types["BigDecimal"] = java.math.BigDecimal;
types[java.math.BigDecimal] = java.math.BigDecimal;
...
var Field = UTIL.extend(Object, {
    ...
    valueTo_: function(value) {
        ...
        if (value instanceof GEOM.Geometry) {
            ...
            _value = new java.util.Date(value.getTime());
        }
        return _value;
    },

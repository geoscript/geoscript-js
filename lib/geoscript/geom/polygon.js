...
var Polygon = util.extend(Geometry, {
    ...
    constructor: function(coords) {
        ...
        var shell = Geometry._factory.createLinearRing(shellCoords);
        ...
        interiors.forEach(function(r, i) {
            ...
            holes[i] = Geometry._factory.createLinearRing(ringCoords);
        }, this);

        this._geometry = Geometry._factory.createPolygon(shell, holes);

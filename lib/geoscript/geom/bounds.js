...
var Bounds = UTIL.extend(Object, {
    ...
    intersection: function(other) {
        // TODO: figure out why this doesn't work with ReferencedEnvelope
        var thisEnv = new Envelope(this.minx, this.maxx, this.miny, this.maxy);
        other = sameProjection(this, other);
        var otherEnv = new Envelope(other.minx, other.maxx, other.miny, other.maxy);
        var intersection = thisEnv.intersection(otherEnv);
        var _bounds = new ReferencedEnvelope(
            intersection.getMinX(), intersection.getMaxX(),
            intersection.getMinY(), intersection.getMaxY(),
            this.projection && this.projection._projection
        );
        // TODO: this should already be null

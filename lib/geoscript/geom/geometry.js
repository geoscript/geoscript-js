...
var BUFFER_CAP_ROUND = require("./util").BUFFER_CAP_ROUND;
...
var _getMethod = function(_geometry, name) {
    var method;
...
var Geometry = UTIL.extend(Object, {
    ...
    get bounds() {
        if (!this.cache.bounds) {
            ...
            var bounds = Bounds.from_(_getMethod(this._geometry, "getEnvelopeInternal")());
            if (this.projection) {

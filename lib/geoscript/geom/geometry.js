...
Geometry.from_ = function(_geometry) {
    ...
    if (Type) {
        ...
        g.setCoordinates(Type._extractCoordinates(_geometry));
    }
    return g;
};
 ...
 *
 *  Extract a coordinates array from a JTS geometry.  Must be implemented by
 *  a subclass.
 */
Geometry._extractCoordinates = function(_geometry) {
    throw "Geometry subclass must implement _extractCoordinates static method.";
};
